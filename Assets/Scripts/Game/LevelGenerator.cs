namespace Game
{
    ...
    public sealed class LevelGenerator : MonoBehaviour, IInitializable
    {
        ...
        public void Initialize(GameManager gameManager)
        {
            ...
            _gameManager.GameDataManager.cubeOffset.Value =
                new Vector3(0, cubePrefab.transform.lossyScale.y + 0.05f, 0);
        ...
        private void OnClick()
        {
                ...
                && _previousCube.CubeShader != null)
            {
                ...
                if (!_previousCube.CubeCutter.Cut(out var cutX))
                {
                    ...
                    Debug.Log("Cannot to cut the cube.");
                    return;
                }
            ...
            var cube = Instantiate(cubePrefab, _gameManager.GameDataManager.nextCubePosition.Value,
                Quaternion.identity);
